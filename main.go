...
var (
	...
	flagVaultAppRoleRoleID   = flag.String("vault.auth-approle-role-id", "", "Vault RoleID of the AppRole.")
	flagVaultAppRoleSecretID = flag.String("vault.auth-approle-secret-id", "", "Vault SecretID of the AppRole.")
